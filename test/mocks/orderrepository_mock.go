...
func (_m *MockOrderRepository) FindAll() ([]domain.Order, error) {
	ret := _m.Called()
...
// MockOrderRepository_FindAll_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindAll'
type MockOrderRepository_FindAll_Call struct {
	*mock.Call
}

// FindAll is a helper method to define mock.On call
func (_e *MockOrderRepository_Expecter) FindAll() *MockOrderRepository_FindAll_Call {
	return &MockOrderRepository_FindAll_Call{Call: _e.mock.On("FindAll")}
}

func (_c *MockOrderRepository_FindAll_Call) Run(run func()) *MockOrderRepository_FindAll_Call {
...
func (_c *MockOrderRepository_FindAll_Call) Return(_a0 []domain.Order, _a1 error) *MockOrderRepository_FindAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockOrderRepository_FindAll_Call) RunAndReturn(run func() ([]domain.Order, error)) *MockOrderRepository_FindAll_Call {
	_c.Call.Return(run)
	return _c
}
